...
##  Homepage Slider
  ...
  * HTML example could be found here: _“index.php”_
...
##  'Featured In Press' Component
  ...
  * HTML example could be found here: _“page-about-us.php”_
...
<nav id="mainmenu" class="mainmenu">
    <ul>
        <li class="logo-wrapper">
            <a href="index.php"><img src="img/logo.png" alt="Alt Text"></a>
        </li>
        <!--Active Menu Item -->
...
##  Services
  ...
  * There are 3 different layouts: 
    * **1 Column** - HTML example could be found here _“page-services-1-column.php”_
    * **3 Columns** - HTML example could be found here _“page-services-3-columns.php”_
    * **4 Columns** - HTML example could be found here _“page-services-4-columns.php”_
  * CSS / LESS style: search for comment containing _“Services Style”_
  * Dependencies: N/A 

##  Pricing Table

  * HTML example could be found here: _“page-pricing.php”_
...
###  Team
  ...
  * HTML example could be found here: _“page-team.php”_
  * CSS / LESS style: search for comment containing _“Our Team Style”_
  * Dependencies: N/A 

###  Open Vacancies

  * HTML example could be found here: _“page-vacancies.php”_
...
###  Portfolio List
  ...
  * There are 4 different layouts available: 
    * **2 Columns, Option 1** - HTML example could be found here _“page-portfolio-2-columns-1.php”_
    * **2 Columns, Option 2** - HTML example could be found here _“page-portfolio-2-columns-2.php”_
    * **3 Columns, Option 1** - HTML example could be found here _“page-portfolio-3-columns-1.php”_
    * **3 Columns, Option 2** - HTML example could be found here _“page-portfolio-3-columns-2.php”_
  * CSS / LESS style: search for comment containing _“Portfolio Style”_
  * Dependencies: N/A 

###  Portfolio Item (Project)

  * HTML example could be found here: _“page-portfolio-item.php”_
  * CSS / LESS style: search for comment containing _“Portfolio Style”_
  * Dependencies: N/A 
...
###  Contact Us
  ...
  * HTML example could be found here: _“page-contact-us.php”_
  * CSS / LESS style: search for comment containing _“Contact Us Style”_
  * Dependencies: N/A 

###  Frequently Asked Questions

  * HTML example could be found here: _“page-faq.php”_
  * CSS / LESS style: search for comment containing _“Frequently Asked Questions Style”_
  * Dependencies: N/A 

###  Testimonials & Clients

  * HTML example could be found here: _“page-testimonials-clients.php”_
...
###  Events
  ...
  * HTML example could be found here: _“page-events.php”_
  * CSS / LESS style: search for comment containing _“Events List Style”_
  * Dependencies: N/A 

###  404 Page

  * HTML example could be found here: _“page-404.php”_
  * CSS / LESS style: search for comment containing _“404 Page Style”_
  * Dependencies: N/A 

###  Sitemap

  * HTML example could be found here: _“page-sitemap.php”_
  * CSS / LESS style: search for comment containing _“Sitemap Style”_
  * Dependencies: N/A 

###  Login

  * HTML example could be found here: _“page-login.php”_
  * CSS / LESS style: search for comment containing _“Login/Register/Reset Password Forms Style”_
  * Dependencies: N/A 

###  Register

  * HTML example could be found here: _“page-register.php”_
  * CSS / LESS style: search for comment containing _“Login/Register/Reset Password Forms Style”_
  * Dependencies: N/A 

###  Password Reset

  * HTML example could be found here: _“page-password-reset.php”_
  * CSS / LESS style: search for comment containing _“Login/Register/Reset Password Forms Style”_
  * Dependencies: N/A 

###  Terms & Privacy

  * HTML example could be found here: _“page-terms-privacy.php”_
  * CSS / LESS style: plain Twitter Bootstrap styles 
  * Dependencies: N/A 

###  Coming Soon

  * HTML example could be found here: _“page-coming-soon.php”_
...
###  Products (Items) List
  ...
  * There are 2 different layouts available (_3 Columns, 4 Columns_). HTML example could be found in a relevant file: 
    * _“page-products-3-columns.php”_
    * _“page-products-4-columns.php”_
  * CSS / LESS style: search for comment containing _“E-commerce Style”_
  * Dependencies: N/A 

###  Product (Item) Description

  * HTML example could be found here: _“page-product-details.php”_
  * CSS / LESS style: search for comment containing _“Product Details Page Style”_
  * Dependencies: N/A 

###  Shopping Cart

  * HTML example could be found here: _“page-shopping-cart.php”_
  * CSS / LESS style: search for comment containing _“E-commerce Style”_
  * Dependencies: N/A 

###  Products Slider

  * HTML example could be found here: _“page-products-slider.php”_
...
###  Blog Posts List
  ...
  * HTML example could be found here: _“page-blog-posts.php”_
...
###  Blog Post
  ...
  * There are 2 different layouts available (_Sidebar Left, Sidebar Right_). HTML example could be found in a relevant file: 
    * _“page-blog-post-left-sidebar.php”_
    * _“page-blog-post-right-sidebar.php”_
  * CSS / LESS style: search for comment containing _“Blog Style”_
  * Dependencies: N/A 

###  Latest & Featured News

  * HTML example could be found here: _“page-news.php”_
